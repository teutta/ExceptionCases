...
public class MTAInstructions_MT200 {
    ...
    public static void main(String[] args) throws Exception {
        String path = "C:\\Users\\teuta\\IdeaProjects\\generateMT\\src\\test\\resources\\mtFiles\\MTAInstructions_MT200_Template.txt";
        ...
        if(sc.hasNext("^[0-9,]+$")) {
            ...
            if(sc.hasNext("[a-zA-Z]{3}")) {
                ...
                if(sc.hasNext("[a-zA-Z0-9]{11}")) {
                    ...
                    String newFilePath = "C:\\Users\\teuta\\IdeaProjects\\generateMT\\src\\test\\resources\\mtFiles\\generatedPayments\\IncomingPayments\\Alternative Instructions\\MT200\\MT200_FBE_" + nameConventionForMT1.format(calendar.getTime()) + "." + nameConventionForMT2.format(calendar.getTime()) + ".000.mt";
