...
public class DTAPaymentEmbargo {
    public static void main(String[] args) throws Exception {
        String path = "C:\\Users\\teuta\\IdeaProjects\\generateMT\\src\\test\\resources\\mtFiles\\MT103_Embargo_dtazv_Template.txt";
        ...
        String newFilePath = "C:\\Users\\teuta\\IdeaProjects\\generateMT\\src\\test\\resources\\mtFiles\\generatedPayments\\OutgoingPayments\\Embargowait\\HCOB2BR.DTAZV_SAPDM." + nameConventionForMT1.format(calendar.getTime()) + "." + nameConventionForMT2.format(calendar.getTime()) + "."+threeDigitNumber+".dta";
        ...
        String zippedFile = "C:\\Users\\teuta\\IdeaProjects\\generateMT\\src\\test\\resources\\mtFiles\\generatedPayments\\OutgoingPayments\\Embargowait\\B2H.PAD.BTEB.AZVJ.EFXP.D" + nameConventionForMT1.format(calendar.getTime()) + ".T" + nameConventionForMT2.format(calendar.getTime()) + ".zip";
