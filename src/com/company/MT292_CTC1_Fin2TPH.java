...
public class MT292_CTC1_Fin2TPH {
    public static void main(String[] args) throws Exception {
        String path = "C:\\Users\\HT\\Desktop\\Regression\\Regression\\generateMT\\src\\test\\resources\\mtFiles\\MT292_CTC1_Fin2TPH_Template.txt";
        ...
        String ref_1 = String.format("TK%06d", number_1);
                ...
                String newFilePath = "C:\\Users\\HT\\Desktop\\Regression\\Regression\\generateMT\\src\\test\\resources\\mtFiles\\generatedPayments\\IncomingPayments\\Fin2TPH\\MT292_FBE_" + nameConventionForMT1.format(calendar.getTime()) + "." + nameConventionForMT2.format(calendar.getTime()) + ".000.mt";
